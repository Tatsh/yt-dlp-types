...
class YoutubeDL:
    ...
    def prepare_outtmpl(self,
                        outtmpl: str,
                        info_dict: _InfoDict,
                        sanitize: bool = False) -> tuple[str, dict[str, object]]:
        ...

    def evaluate_outtmpl(self, outtmpl: str, info_dict: _InfoDict, *args: object,
                         **kwargs: object) -> str:
        ...
    ...
    def process_ie_result(self,
                          ie_result: _InfoDict,
                          download: bool = True,
                          extra_info: Mapping[str, object] | None = None) -> _InfoDict:
        ...
    ...
    def process_subtitles(self, video_id: str, normal_subtitles: Mapping[str, object],
                          automatic_captions: Mapping[str, object]) -> dict[str, object] | None:
        ...
    ...
    def existing_file(self,
                      ...
                      *,
                      default_overwrite: bool = True) -> object | None:
        ...
    ...
    @staticmethod
    def filter_requested_info(info_dict: _InfoDict,
                              actually_filter: bool = True) -> _InfoDict | None:
        ...
    ...
    def run_all_pps(self,
                    key: str,
                    info: _InfoDict,
                    *,
                    additional_pps: Collection[PostProcessor] | None = None) -> _InfoDict:
        ...
    ...
    def pre_process(
            ...
            ie_info: _InfoDict,
            key: str = 'pre_process',
            files_to_move: Mapping[str, object] | None = None
    ...
    def post_process(self,
                     filename: str,
                     info: _InfoDict,
                     files_to_move: Mapping[str, object] | None = None) -> _InfoDict:
        ...
    ...
    def render_subtitles_table(self, video_id: str,
                               subtitles: Iterable[Mapping[str, object]]) -> str | None:
        ...
    ...
    def list_subtitles(self,
                       video_id: str,
                       subtitles: Iterable[Mapping[str, object]],
                       name: str = 'subtitles') -> None:
        ...
    ...
    def build_request_director(self,
                               ...
                               preferences: Collection[object] | None = None) -> RequestDirector:
        ...
