...
class FileDownloader:
    ...
    def wrap_file_access(action: str, *, fatal: bool = False) -> object:  # type: ignore[misc]
        ...

    def sanitize_open(self, filename: str,
                      open_mode: OpenTextMode | OpenBinaryMode) -> tuple[IO[Any], str]:
        ...
    ...
    def report_retry(self,
                     ...
                     count: int,
                     retries: int,
                     frag_index: int | type[NO_DEFAULT] = ...,
